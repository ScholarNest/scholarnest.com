...
const PerformanceTunningComponent = () => {
    ...
    const Faqs = [
        {
            ...
            ans: "We provide lifetime access to the course material if you don't misuse or share your course access with others and comply with our terms"
        },
        {
            id: "faq2",
            ques: "Do you have refund policy?",
            ans: "No. This course does not come with a refund policy. Once sold, you cannot get a refund for this self-paced course."
        },
        {
            id: "faq3",
            ques: "How do you provide support?",
            ans: "We have a Q&A forum where you can ask questions, and our team will answer your queries. We also provide a course coordinator's email address and WhatsApp number so you can contact us if you need to escalate the support issue."
        }
    ]
        ...
        <>
           <div class={classes.mainBody}>
            ...
            <h2 class={classes.headings}>What you'll learn</h2>
                ...
                <br />
                <br />
                    <p  class={classes.pfs+' my-2 px-md-2'}> 
...
The course will simulate and generate various performance problems using large volumes of data at the magnitude of GBs and help you gain knowledge to solve real-life problems.
                ...
                <br />
                    ...
                    Performance debugging, benchmarking, analyzing and pinpointing the root cause</p>
                    <br />
                    <hr />
                    <br />
                    <p class="d-flex my-2"> 
...
You must already know Spark programming in Python or Scala language</p>
                    <br />
                    <hr />
                    <br />
                    <p class="d-flex ">  <div>
...
You must be already familiar with Apache Spark Architecture and Internals</p>
                        <br />
                    <hr />
                    <br />
...
You also need to be familier with Databricks Cloud platform features and capabilities</p>
                        <br />
                    <hr />
                    <br />
            ...
            <div className={classes.div4 + ' '+ classes.newBg+ ' px-md-5'}>
                ...
                <div className="row mx-0 justify-content-center">
                    <div className={classes.featureBox + " col-10 col-sm-6 col-md-4 bg-white border "}>
                        ...
                        <h3  class={classes.h3style+" fw-bold"}> Total Support</h3>
                        <p class='p-3'> We provide support throughout your learning and answer every question during business hours. For blocker issues, you can also request a one-to-one technical support call. </p></div>
                    <div className={classes.featureBox + " col-10 col-sm-6 bg-white border col-md-4"}>
                        ...
                        <h3  class={classes.h3style + " fw-bold"}>Certification Ready</h3>
                    ...
                    <div className={classes.featureBox + " col-10 col-sm-6  bg-white border col-md-4"}>
                        ...
                        <h3 class={classes.h3style + " fw-bold"}> Capstone Project</h3>
                        <p class='p-3'> The course includes lifetime access to any future updates, upgrades, revisions, modifications, or topics included in the same course at no additional cost. </p></div>
                </div>
                <br />
            </div>
            <br />
...
export default PerformanceTunningComponent;