    ...
    <div className={classes.footer}>
      <div className={classes.contain}>
        ...
        <div className={classes.col2}>
          ...
          <ul>
            <li><Link href="https://www.scholarnest.com/about-us/">About Us</Link></li>
            <li><Link href="/contactUs">Contact</Link></li>
            <li><Link href="https://www.scholarnest.com/faqs/">Help & Support (FAQs) </Link> </li>
          </ul>
        </div>
        <div className={classes.col2}>
          <div className={classes.colh1}>
          ...
          <ul>
          <li><Link href="https://www.scholarnest.com/membership/">Subscription</Link></li>
          <li><Link href="https://www.scholarnest.com/become-an-instructor/">Teach</Link></li>
          <li><Link href="https://www.scholarnest.com/forum/">Forum</Link></li>
          </ul>
        </div>
