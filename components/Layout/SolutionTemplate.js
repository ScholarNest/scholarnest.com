    ...
    <div>
     ...
     <div style={{padding:"0",margin:"auto 0"}} className="row">
        <div className="col-6" style={{backgroundColor:"purple"}}>
           ...
           <button  onClick={() =>router.push(props.link)} class="btn my-4" style={{marginLeft: "10%",border:"1px solid white",display:"flex",flexDirection:"row",color:"white"}}>Learn more  <AiOutlineArrowRight style={{marginLeft:"4px",marginTop:"5px"}} /></button>
