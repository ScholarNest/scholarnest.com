  ...
  return (
    <>
          ...
          <div style={{ width: "90%", margin: "0 auto" }} className="my-4 text-light">
            ...
            <div className="row  text-start  " style={{ height: "auto", borderBottom: "1px solid white" }}>
              {solutions.map((sol,index) => (
                <div key={index} onClick={() => router.push(sol.link)} className={classes.solDivstyle + " col-xl-4 col-lg-4 col-12 col-sm-12 col-md-6 my-1 p-3"}>
      ...
      <div className={classes.feedbackBox} >
        <h2 className=" text-center my-2"  >What our customers say</h2>
        <br />
        <Carousel
          dynamicHeight={false}
          autoPlay
            ...
            testimonials.map((testimonial, index) => {
              ...
              return (<div  key={index} style={{ border: "1px groove" }} >
                <div style={{ margin: "0 auto", padding: "10px" }} className="mx-auto">
                  ...
                  <p className="mb-3">{testimonial.designation} @{testimonial.company}</p>
      ...
      <ScrollAnimationWrapper className="w-full">
        <motion.div variants={scrollAnimation} custom={{ duration: 3 }}>
          <div style={{ backgroundColor: "rgb(251 251 249)" }} className={classes.letsConnect + " rounded-xl  py-8 sm:py-14 px-6 sm:px-12 lg:px-16 w-full flex flex-col sm:flex-row justify-between items-center z-10 bg-white-500"}>
            ...
            <button className={
              "py-2 lg:py-4 px-8 lg:px-16 text-white-500 font-semibold rounded-lg bg-orange-500 hover:shadow-orange-md transition-all outline-none"} onClick={() => router.push("/contact-us")}> <p className="text-white-500"> Get Started </p> </button>
          </div>
