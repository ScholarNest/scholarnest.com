...
const LearningAWSContainer = () => {
  ...
  const Faqs = [
    ...
    // },
    {
      ...
      ans: "At the moment, we do not offer support for this program."
    }
  ]
  return (
    <>
      <div class={classes.mainBody}>
          ...
          <div className="col-md-6 col-12 d-flex justify-content-center align-items-center">
            <div>
              ...
              <div class={classes.butns + " row gap-2 justify-content-center"}>
                ...
                <a href='https://www.scholarnest.in/enroll/2222089?et=free_trial' class={classes.nfpbutn + " col-sm-5 col-md-4 col-12 btn   text-center  "}> Free Preview  </a>
        ...
        <div  className={classes.secondDiv + " row mx-4 px-md-2"}>
          ...
          <div className=" col-12 col-sm-12 col-md-6 h-100">
            ...
            Master the fundamentals of AWS Cloud and prepare for the AWS Certified Cloud Practitioner CLF-C01, complete with hands-on exercises and a practice exam to enhance your learning experience.
            </p>
          ...
          <div className={classes.afterSecndDiv + " col-12 col-sm-12 col-md-6 px-2 px-md-5"}>
            ...
            <p class="d-flex my-2">
              <div>
                ...
                AWS Cloud Fundamentals - Gain practical, hands-on knowledge of AWS Cloud fundamentals.
</p>
            <br />
            <hr />
            <br />
            <p class="d-flex my-2">
              ...
              AWS Certified Cloud Practitioner (CLF-C01) Curriculum - Cover the curriculum required for the AWS Certified Cloud Practitioner exam.
</p>
            <br />
            <hr />
            <br />
            ...
            <p class="d-flex my-2">
              ...
              Certification Exam Practice - Engage in exercises and solutions to prepare for the certification exam.</p>
            <br />
            <hr />
            <br />
            <p class="d-flex my-2">
              ...
              Beyond the Exam - Explore AWS Cloud architecture, services, and concepts that go beyond the certification exam.</p>
            <br />
            <hr />
            <br />
          </div>
...
Ensure a foundational understanding of computer basics, including file management, navigation, and general computer usage.</p>
          ...
          <div className={classes.fifthDiv + ' row mx-2 px-md-5'}>
            ...
            <div className={classes.courseContent + " col-md-4 col-12"}>
              <Card.Body class={classes.cardDet + " bg-white"} >
                <img class="w-100" src="/assets/solutions/AcademySolutions/8.jpg" alt="Learning AWS Cloud Fundamentals" />
        ...
        <div style={{ minHeight: "300px", backgroundColor: '#c3d4e8' }} class={classes.div4 + " row mx-0 px-md-5"}>
          ...
          <div class=" col-md-4 col-12 d-flex justify-content-center  align-items-md-center">
            <button onClick={() => { router.push('https://www.scholarnest.in/enroll/2222089') }} style={{ height: '70px', backgroundColor: '#e79913' }} class="btn rounded-pill w-75  px-5 text-center text-light fw-bold"> Buy Now </button>
          </div>
